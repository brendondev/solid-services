...
export class DigitalSignatureService {
   ...
   *
   * IMPORTANTE: Este é o único lugar onde notificações de assinatura são criadas no banco.
   * O método approveQuotation apenas envia emails, não cria notificações no banco.
   */
